...
private:
	...
	void DrawGameObjectNode(CE::GameObject* pGameObject, EditorContext& context);			// Draws a single GameObject node in the hierarchy
...
public:
	...
	void Draw(EditorContext& context);														// Draws the Hierarchy panel to create and store GameObjects in the current scene
};