...
namespace CE
{
	...
	public:
		ComponentFactory() = delete;																								// Constructor

		static void CreateComponent(GameObject* pGameObject, const std::string& componentID, tinyxml2::XMLElement* pElement);		// Creates a component of the given type and attaches it to the GameObject, using XML data if available
